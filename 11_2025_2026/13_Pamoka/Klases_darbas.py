...
vietoves = [
    (b'Paneriai (Vilnius)', 70000),
    (b'Kauno Devintas fortas', 50000),
    (b'Kauno VII fortas', 3000),
    (b'Kauno geto likvidavimas', 10000), 
    (b'\xc5\xa0iauli\xc5\xb3 geto likvidavimas', 8000),
    (b'K\xc4\x97dainiai', 2000),
    (b'Plung\xc4\x97', 1800),
    (b'Tel\xc5\xa1iai / Raini\xc5\xb3 mi\xc5\xa1kas', 1500),
    (b'Garg\xc5\xbedai', 200),
    (b'Utena', 2000),
    (b'Alytus', 1500),
    (b'\xc5\xa0ven\xc4\x8dionys / \xc5\xa0ven\xc4\x8dion\xc4\x97liai', 3800),
    (b'Panev\xc4\x97\xc5\xbeys', 8000),
